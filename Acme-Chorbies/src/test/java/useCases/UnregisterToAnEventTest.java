...
@Transactional
public class UnregisterToAnEventTest extends AbstractTest {

	/*
	 * Unregister to an event - Chorbi
	 *
    ...
    public void setup() {
		...
		while(this.chorbies.get(0).getEvents().isEmpty())
			Collections.shuffle(this.chorbies);
		this.events = new ArrayList<Event>(this.chorbies.get(0).getEvents());
	}
	@Test
	public void driver() {
