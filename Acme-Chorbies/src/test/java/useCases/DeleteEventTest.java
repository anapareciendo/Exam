...
@Transactional
public class DeleteEventTest extends AbstractTest {
	 ...
	 * 
	 * Cobertura del test:
	 * -El usuario autenticado existe y se puede borrar el evento(test positivo)
	 * -El usuario no está autenticado y no se puede borrar el evento (test negativo)
	 */
	@Autowired
